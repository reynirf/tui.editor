...
| --- | --- | --- |
| [`chart`](https://github.com/nhn/tui.editor/tree/master/plugins/chart) | [`glaze-text-editor-plugin-chart`](https://www.npmjs.com/package/glaze-text-editor-plugin-chart) | Plugin to render chart |
| [`code-syntax-highlight`](https://github.com/nhn/tui.editor/tree/master/plugins/code-syntax-highlight) | [`glaze-text-editor-plugin-code-syntax-highlight`](https://www.npmjs.com/package/glaze-text-editor-plugin-code-syntax-highlight) | Plugin to highlight code syntax |
| [`color-syntax`](https://github.com/nhn/tui.editor/tree/master/plugins/color-syntax) | [`glaze-text-editor-plugin-color-syntax`](https://www.npmjs.com/package/glaze-text-editor-plugin-color-syntax) | Plugin to color editing text |
| [`table-merged-cell`](https://github.com/nhn/tui.editor/tree/master/plugins/table-merged-cell) | [`glaze-text-editor-plugin-table-merged-cell`](https://www.npmjs.com/package/glaze-text-editor-plugin-table-merged-cell) | Plugin to merge table cells |
| [`uml`](https://github.com/nhn/tui.editor/tree/master/plugins/uml) | [`glaze-text-editor-plugin-uml`](https://www.npmjs.com/package/glaze-text-editor-plugin-uml) | Plugin to render UML |
...
You can install each plugin using the command, and add the name of the plugin you want to install to `${pluginName}` below. For example, if you install the `chart` plugin, install it as`npm install glaze-text-editor-plugin-chart`.

```sh
$ npm install --save glaze-text-editor-plugin-${pluginName} # Latest Version
$ npm install --save glaze-text-editor-plugin-${pluginName}@<version> # Specific Version
```
...
```
- node_modules/
   ├─ glaze-text-editor-plugin-${pluginName}
   │     ├─ dist/
...
```js
import pluginFn from 'glaze-text-editor-plugin-${pluginName}';
```

- CommonJS

```js
const pluginFn = require('glaze-text-editor-plugin-${pluginName}');
```
...
* `usageStatistics`: It decides whether to collect the plugin as GA for `glaze-text-editor`.
